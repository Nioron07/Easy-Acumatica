...
class TestBatchCall:
    ...
    # --- THIS TEST WAS REMOVED as execute_async no longer exists ---
    ...
    def test_batch_call_timeout(self, client):
        ...
        # *** MODIFIED LINE: Changed expected exception type ***
...
class TestBatchConvenienceFunctions:
    ...
    def test_batch_call_function(self, client):
        ...
        # *** MODIFIED COMMENT: Corrected the description of what batch_call returns ***
        # Should return an unexecuted BatchCall instance
    ...
    def test_create_batch_from_filters(self, client):
        ...
        filters = [QueryOptions(top=5), QueryOptions(top=10)]
